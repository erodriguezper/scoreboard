 ...
 */
package com.sportradar.scoreboard.tests.factory;
...
public class MatchFactoryTest {
    ...
    public void testCreate(){
        Match match = new Match(ID, HOME_TEAM_NAME, AWAY_TEAM_NAME);
        assertEquals(match, MatchFactory.createMatch(ID, HOME_TEAM_NAME, AWAY_TEAM_NAME));
    }
    
    @Test
    public void testCreateWithScore(){
        Match match = new Match(ID, HOME_TEAM_NAME, HOME_TEAM_SCORE, AWAY_TEAM_NAME, AWAY_TEAM_SCORE);
